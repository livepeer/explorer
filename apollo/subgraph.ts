...
export type ProtocolByBlockQuery = { __typename: 'Query', protocol?: { __typename: 'Protocol', id: string, totalVolumeUSD: string, totalVolumeETH: string, participationRate: string, inflation: string, activeTranscoderCount: string, delegatorsCount: string, lockPeriod: string } | null };
