      ...
      >
        {delegator.delegate && (
          <Link
            ...
            as={`/accounts/${delegator.delegate.id}/orchestrating`}
            passHref
          >
            <A
        ...
        <Stat
          ...
          meta={
            <Box>
              ...
              >
                <Flex css={{ alignItems: "center" }}>
                  <Text size="2">Lifetime Undelegated</Text>
                  <Flex>
                    <ReactTooltip
                      id="tooltip-unstaked"
                      className="tooltip"
                ...
                <Box>
                  {unbonded > 0 ? (
                    <Text size="2" css={{ fontWeight: 600, color: "$red" }}>
                      -{abbreviateNumber(unbonded, 3)} LPT
                    </Text>
                  ) : (
                    0
              ...
              <Flex css={{ fontSize: "$3", justifyContent: "space-between" }}>
                <Flex css={{ alignItems: "center" }}>
                  <Text size="2">Lifetime Rewards</Text>
                  <Flex>
                    <ReactTooltip
                      id="tooltip-rewards"
                      className="tooltip"
