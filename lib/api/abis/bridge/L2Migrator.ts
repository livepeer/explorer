export const l2Migrator = [
  {
    inputs: [
      { internalType: "address", name: "_l1Migrator", type: "address" },
      {
  ...
  },
  {
    ...
    inputs: [
      {
        components: [
          { internalType: "address", name: "l1Addr", type: "address" },
          { internalType: "address", name: "l2Addr", type: "address" },
  ...
  {
    inputs: [{ internalType: "address", name: "_l1Migrator", type: "address" }],
    name: "setL1Migrator",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
